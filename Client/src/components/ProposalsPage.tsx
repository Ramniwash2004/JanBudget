...
export function ProposalsPage() {
  ...
  // heading, description, budget, wardNumber, location, imageLink
  ...
  const handleSubmitProposal = async () => {
    if(!newProposal.image) {
      newProposal.image = "https://images.unsplash.com/photo-1563455433861-a0e8ed61d7d1?w=400&h=300&fit=crop"
    }
    ...
    if (
      ...
      alert("Please fill all data points")
      return;
    }
    ...
    try {
      ...
      const res = await addProposal(payload);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value: any) =>
                  setNewProposal({ ...newProposal, ward: value })
                }
              >
                <SelectTrigger>
                  <SelectValue placeholder="Select ward" />
        ...
        {fetchedProposals.map((newproposals) => (
            <ProposalCard key={newproposals?._id} proposal={newproposals} getStatusBadge={getStatusBadge} />
          ))}

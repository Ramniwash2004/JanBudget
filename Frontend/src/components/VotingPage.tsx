    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Active Voting Phase</h1>
          <p className="text-lg text-gray-600">Vote for your preferred projects in each ward</p>
        </div>
        ...
        <Alert className="mb-8 border-primary bg-primary/5">
          ...
          <AlertDescription className="text-primary">
            Voting is currently open for Q2 budget allocation. Make sure to cast your vote before the deadline!
          </AlertDescription>
        </Alert>

        {/* Ward Selection Tabs */}
        <Tabs value={selectedWard} onValueChange={setSelectedWard} className="mb-8">
          <TabsList className="grid w-full grid-cols-3">
            <TabsTrigger value="Ward 1">Ward 1 - Central Market</TabsTrigger>
            <TabsTrigger value="Ward 2">Ward 2 - Residential</TabsTrigger>
            <TabsTrigger value="Ward 3">Ward 3 - Industrial</TabsTrigger>
          </TabsList>

          {Object.entries(votingData).map(([ward, data]) => (
            <TabsContent key={ward} value={ward}>
              {/* Ward Statistics */}
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold">{data.votedCount.toLocaleString()}</p>
                      </div>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-lg font-bold">{data.timeRemaining}</p>
                      </div>
                ...
                <CardContent>
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      <span>Votes Cast: {data.votedCount.toLocaleString()}</span>
                      <span>Target: {data.totalVoters.toLocaleString()}</span>
                    </div>
              ...
              {!hasVoted ? (
                <Card className="mb-8">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Select one proposal you would like to see funded in {ward}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Live voting results (votes are anonymous)
                  </CardDescription>
                </CardHeader>
                <CardContent>
                        ...
                        <div key={proposal.id} className="space-y-2">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="text-right">
                              <div className="font-semibold">{proposal.votes} votes</div>
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                    <div className="flex items-start space-x-2">
                      ...
                      <div className="text-sm text-blue-800">
                        <p className="font-semibold mb-1">Voting Information</p>
                        <ul className="space-y-1 text-xs">
                          <li>• All votes are anonymous and secure</li>
                          <li>• Results are updated in real-time</li>
                          <li>• The proposal with the most votes will be funded</li>
                          <li>• Voting closes in {data.timeRemaining}</li>
                        </ul>
                      </div>
                    </div>
                  </div>

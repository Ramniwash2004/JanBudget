        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-4">
              Empowering Citizens, Building Together
            </h1>
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              Participate in your city's budget allocation and help build a better community
            </p>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Ward Budget Overview</h2>
            <p className="text-lg text-gray-600">Track budget allocation and project progress in each ward</p>
          </div>
